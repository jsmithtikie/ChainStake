...
#[derive(Debug)]
pub struct ChainStakeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainStakeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainStake processing");
    
    let mut processor = ChainStakeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainStakeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainStakeProcessor::new(false);
